...
//media imports
import winekakiWeb from '../assets/winekaki.png'

export default function Hero11wp() {
  return (
        ...
        <div className="row" >
            <div className="col-lg-6 col-12 my-auto projectText text-lg-start text-center">
                <div className="ps-0 ps-lg-5 mt-3">
                    ...
                    <p className="mt-3"> Woocommerce store built on<br />Elementor Pro</p>
                    <p className="col pt-2">Company: Wine Kaki  </p>
                    <a href="https://www.winekaki.com/" target="_blank" className="col-2 btn btn-md btn-light greenBtn">visit</a>
                </div>
            </div>
            <div className="col-lg-6 col-12 order-lg-last order-first px-5 px-lg-0 d-flex">
                <img src={winekakiWeb} className="imageSS img-fluid w-100 me-auto" />
            </div>
        </div>
    </div>
)
