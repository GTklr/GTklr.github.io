...
//media imports
import mistDroneWeb from '../assets/mist-drone.png'

export default function Hero4wp() {
  return (
    <div className="container SectionDiv ScrollSnapStart">
        <div className="row">
            ...
            <div className="col-lg-6 col-12 order-first px-5 px-lg-0 d-flex">
                <img src={mistDroneWeb} className="shadow imageSS img-fluid w-100 ms-auto" />
            </div>
        </div>
    </div>
)
