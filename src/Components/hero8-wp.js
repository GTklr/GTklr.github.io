...
//media imports
import un2Web from '../assets/un2beauty.png'

export default function Hero8wp() {
  return (
        ...
        <div className="row" >
            <div className="col-lg-6 col-12 my-auto projectText text-lg-start text-center">
                <div className="ps-0 ps-lg-5 mt-3">
                    ...
                    <p className="col pt-2">Company: UN2BEAUTY KOREA </p>
                    <a href="https://www.un2beauty.my/" target="_blank" className="col-2 btn btn-md btn-light greenBtn">visit</a>
                </div>
            </div>
            <div className="col-lg-6 col-12 order-lg-last order-first px-5 px-lg-0 d-flex">
                <img src={un2Web} className="imageSS img-fluid w-100 me-auto" />
            </div>
        </div>
    </div>
)
