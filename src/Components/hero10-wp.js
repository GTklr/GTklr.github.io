...
//media imports
import catchcrewWeb from '../assets/catchcrew.png'

export default function Hero10wp() {
  return (
        ...
        <div className="row">
            ...
            <div className="col-lg-6 col-12 my-auto text-lg-start text-center">
                <div className="ps-0 ps-lg-5 mt-3">
                    ...
                    <p className="col pt-2">Company: CatchCrew.co</p>
                    <a href="https://www.catchcrew.co/" target="_blank" className="col-2 btn btn-md btn-light greenBtn">visit</a>
                </div>
            </div>
            <div className="col-lg-6 col-12 order-first px-5 px-lg-0 d-flex">
                <img src={catchcrewWeb} className="imageSS img-fluid w-100 ms-auto" />
            </div>
        </div>
    </div>
)
